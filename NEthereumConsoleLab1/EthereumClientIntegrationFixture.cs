...
namespace NEthereumConsoleLab1
{

    public static class Web3Factory
    {
        private static Nethereum.Web3.Web3 _web3;
        public static Nethereum.Web3.Web3 GetWeb33()
        {
            if(_web3 == null) _web3 = new Nethereum.Web3.Web3(AccountFactory.GetAccount(), ClientFactory.GetClient());
            return _web3;
        }
