        ...
        public async Task ShouldBeAbleToCallAndReadEventLogs()
        {
          ...
          var web3 = new Geth.Web3Geth(account);
           ...
           await web3.Miner.Start.SendRequestAsync(6);
            var gas = new HexBigInteger(1100000);
          ...
          var transactionHash = await multiplyFunction.SendTransactionAsync(senderAddress,gas,null, 7);
          receipt =  await multiplyFunction.SendTransactionAndWaitForReceiptAsync(senderAddress, gas, null, null, 8);
