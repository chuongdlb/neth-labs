...
namespace Nethereum.Tutorials
{
    public class Deployment
    {
        ...
        public Deployment(ITestOutputHelper output)
        {
            this.output = output;
        }
        [Fact]
        public async Task ShouldBeAbleToDeployAContract()
        {
          ...
          var gas = new HexBigInteger(110000);



          var transactionHash = await web3.Eth.DeployContract.SendRequestAsync(abi, byteCode, senderAddress, gas, multiplier);
